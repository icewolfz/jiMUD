...
define("ace/mode/jimud", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/jimud_highlight_rules", "ace/mode/folding/jimud"], function (require, exports, module) {
    ...
    var docs = {
        ...
        'CLOSE': '<b>#CLOSE <i>name or id</i></b><br/>Close current tab/window or named window',
        'ALL': '<b>#ALL {commands}</b><br/>Send commands to all client windows as if sent from command line',
        'TAB': '<b>#TAB <i>character or id</i></b><br/>Create a new client tab in current window',
        'NA': '<b><u>#NA</i>ME <i>name id</i></b><br/>Set the name for the current window or for the window id<br/>If no arguments, displays current window name',
        'NAME': '<b><u>#NA</i>ME <i>name id</i></b><br/>Set the name for the current window or for the window id<br/>If no arguments, displays current window name',
        'ID': '<b>#ID</b><br/>Display client id',
        'CLEARNA': '<b><u>#CLEARNA</u>ME <i>name or id</i></b><br/>Clear client current or named client\'s name',
        'CLEARNAME': '<b><u>#CLEARNA</u>ME <i>name or id</i></b><br/>Clear client current or named client\'s name',
        'TO': '<b>#TO name or id</b><br/>Send commands to named client or client id as if sent from command line',
        'WRAP': '<b><u>#WR</u>AP <i>number</i></b><br/>Toggle word wrap and set the wrap column to number if supplied, if number is 0 disables wrap at column',
        ...
        'clientid': '<b>clientid</b><br/>return current client id',
        'clientname': '<b>clientname(<i>name, id</i>)/b><br/>Return or set the client name',
        'action': '<b>action</b><br/>Last triggered action executed',
        'trigger': '<b>trigger</b><br/>Last text, event, or pattern that caused last trigger to fire  ',
        'caption': '<b>caption</b><br/>returns the executing item\'s caption, only set for buttons and context menu items',
        'characterid': '<b>characterid</b><br/>returns current character id for client'
    };
    (function () {
        this.$id = "ace/mode/jimud";
        this.getCompletions = function (state, session, pos, prefix) {
            var functions = ["bitand", "bitnot", "bitor", "bitset", "bitshift", "bittest", "bitxor", "eval", "dice", "diceavg", "dicemin", "dicemax", "dicedev", "zdicedev", "random", "number", "isfloat", "isnumber", "string", "float", "case", "switch", "if", "lower", "upper", "proper", "char", "ascii", "begins", "ends", "len", "pos", "ipos", "regex", "trim", "trimleft", "trimright", "time", "color", "zcolor", "ansi", "clientname"].map(function (word) {
                return {
                    name: word,
                    value: '${' + word + "()}",
                    score: 0,
