...
function SortArrayByPrioity(a, b) {
...
exports.SortArrayByPrioity = SortArrayByPrioity;
...
exports.FilterArrayByKeyValue = FilterArrayByKeyValue;
...
exports.CharAllowedInURL = CharAllowedInURL;
...
String.prototype.paddingRight = function (paddingValue) {
    if (typeof paddingValue == 'number') {
        if (paddingValue <= this.length)
            return this;
        paddingValue = " ".repeat(paddingValue - this.length);
        return this + paddingValue;
    }
    if (paddingValue.length <= this.length)
        return this;
