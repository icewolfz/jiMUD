 ...
 */
class Tests extends EventEmitter {
    /**
    ...
    constructor(client) {
        ...
        this.TestFunctions["TestList()"] = function () {
            ...
            for (var t in this.TestFunctions) {
                if (!this.TestFunctions.hasOwnProperty(t))
                    continue;
                sample += "\t" + t + "\n";
            }
        ...
        this.TestFunctions["TestColorsDetails()"] = function () {
            ...
            for (var bg = 40; bg <= 47; bg++) {
                for (var a in ansi_1.Ansi) {
                    if (typeof ansi_1.Ansi[a] !== 'number')
                        continue;
                    if (a == "Rapid")
                        continue;
                    //-16
                    if (a == "None")
                        sample += "\x1B[0m " + ansi_1.AnsiColorCode[(bg - 10)].toString().paddingRight(16) + " | ";
                    else
                    ...
                    for (var fg = 30; fg <= 37; fg++) {
                        if (a == "None")
                            ...
                            sample += "\x1B[" + bg + "m\x1B[" + ansi_1.Ansi[a] + ";" + fg + "m " + ("[" + ansi_1.Ansi[a] + ";" + fg + "m").paddingRight(7);
                    }
                    sample += "\x1B[0m\n";
                }
                /*
        ...
        /*
        this.TestFunctions["TestMapper()"] = function () {
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": 0, "dir": "", "area": "" }, "area": "Doc Build Samples Area", "exits": { "south": { "num": 87723359, "dir": "south", "area": "Doc Build Samples Area", "isdoor": 0 }, "east": { "num": -329701270, "dir": "east", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 1", "num": 1968208336, "indoors": 0 });
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": 1968208336, "dir": "east", "area": "Doc Build Samples Area" }, "area": "Doc Build Samples Area", "environment": "wood", "exits": { "south": { "num": 1916648905, "dir": "south", "area": "Doc Build Samples Area", "isdoor": 0 }, "east": { "num": -1688332036, "dir": "east", "area": "Doc Build Samples Area", "isdoor": 0 }, "west": { "num": 1968208336, "dir": "west", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 2", "num": -329701270, "indoors": 0 });
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": -329701270, "dir": "east", "area": "Doc Build Samples Area" }, "area": "Doc Build Samples Area", "environment": "jungle", "exits": { "south": { "num": -348853133, "dir": "south", "area": "Doc Build Samples Area", "isdoor": 0 }, "west": { "num": -329701270, "dir": "west", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 3", "num": -1688332036, "indoors": 0 });
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": -1688332036, "dir": "south", "area": "Doc Build Samples Area" }, "area": "Doc Build Samples Area", "environment": "grass", "exits": { "north": { "num": -1688332036, "dir": "north", "area": "Doc Build Samples Area", "isdoor": 0 }, "south": { "num": 2072768994, "dir": "south", "area": "Doc Build Samples Area", "isdoor": 0 }, "west": { "num": 1916648905, "dir": "west", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 6", "num": -348853133, "indoors": 0 });
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": -348853133, "dir": "west", "area": "Doc Build Samples Area" }, "area": "Doc Build Samples Area", "environment": "desert", "exits": { "north": { "num": -329701270, "dir": "north", "area": "Doc Build Samples Area", "isdoor": 0 }, "south": { "num": 210551156, "dir": "south", "area": "Doc Build Samples Area", "isdoor": 0 }, "east": { "num": -348853133, "dir": "east", "area": "Doc Build Samples Area", "isdoor": 0 }, "west": { "num": 87723359, "dir": "west", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 5", "num": 1916648905, "indoors": 1 });
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": 1916648905, "dir": "west", "area": "Doc Build Samples Area" }, "area": "Doc Build Samples Area", "environment": "tundra", "exits": { "north": { "num": 1968208336, "dir": "north", "area": "Doc Build Samples Area", "isdoor": 0 }, "south": { "num": -1674322715, "dir": "south", "area": "Doc Build Samples Area", "isdoor": 0 }, "east": { "num": 87723359, "dir": "east", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 4", "num": 87723359, "indoors": 0 });
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": 87723359, "dir": "south", "area": "Doc Build Samples Area" }, "area": "Doc Build Samples Area", "environment": "water", "exits": { "north": { "num": 87723359, "dir": "north", "area": "Doc Build Samples Area", "isdoor": 0 }, "east": { "num": 210551156, "dir": "east", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 7", "num": -1674322715, "indoors": 0 });
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": -1674322715, "dir": "east", "area": "Doc Build Samples Area" }, "area": "Doc Build Samples Area", "environment": "jungle", "exits": { "north": { "num": 1916648905, "dir": "north", "area": "Doc Build Samples Area", "isdoor": 0 }, "east": { "num": 2072768994, "dir": "east", "area": "Doc Build Samples Area", "isdoor": 0 }, "west": { "num": -1674322715, "dir": "west", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 8", "num": 210551156, "indoors": 0 });
            Mapper.processGMCP("Room.Info", { "details": [], "doors": {}, "prevroom": { "num": 210551156, "dir": "east", "area": "Doc Build Samples Area" }, "area": "Doc Build Samples Area", "exits": { "north": { "num": -348853133, "dir": "north", "area": "Doc Build Samples Area", "isdoor": 0 }, "west": { "num": 210551156, "dir": "west", "area": "Doc Build Samples Area", "isdoor": 0 } }, "name": "Sample room 9", "num": 2072768994, "indoors": 0 });
        };
        */
