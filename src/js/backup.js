...
class Backup extends EventEmitter {
    ...
    save(version) {
        var _db = new sqlite3.Database(path.join(library_1.parseTemplate("{data}"), "map.sqlite"));
        ...
        $.ajax({
            ...
            success: (data) => {
                if (!data)
                    ...
                    if (typeof (this._save[2]) === "function")
                        this._save[2]();
                    this.close();
                }
            },
