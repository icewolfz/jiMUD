...
export class Profiles {
    ...
    public variablesAdvanced: boolean;
...
export let SettingList: any[] = [
    ...
    ['profiles.variablesAdvanced', 0, 1, false],
    ['enableVariable', 0, 1, true],
    ['variableChar', 0, 0, '@', 1],    
];
...
export class Settings {
    ...
    public getValue(setting: string) {
        switch (setting) {
            ...
            case 'profiles.variablesAdvanced': return this.profiles.variablesAdvanced;
    ...
    public setValue(setting: string, value) {
        switch (setting) {
            ...
            case 'profiles.contextsAdvanced':
                ...
                return true;
            case 'profiles.variablesAdvanced':
                this.profiles.variablesAdvanced = value;
                return true;
    ...
    public clearValue(setting: string, value) {
        switch (setting) {
            ...
            case 'profiles.contextsAdvanced':
                ...
                return true;
            case 'profiles.variablesAdvanced':
                delete this.profiles.variablesAdvanced;
                return true;
            case 'profiles.codeEditor':
    ...
    public static defaultValue(setting) {
        switch (setting) {
            ...
            case 'profiles.variablesAdvanced': return false;
            ...
            case 'enableVariable': return true;
            case 'variableChar': return '@';
