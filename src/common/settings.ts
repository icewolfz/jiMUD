...
export let SettingList: any[] = [
    ...
    ['simpleEdit', 0, SettingType.Boolean, false],
    ['selectLastCommand', 0, SettingType.Boolean, true],
    ['statusMode', 0, SettingType.Number, 0],
...
export class Settings {
    ...
    public backupReplaceCharacters;
    ...
    public commandMinLines: number;
    public commandScrollbars: boolean;
    public enableCrashReporting: boolean;
    public ignoreInputLeadingWhitespace: boolean;

    public skipMore: boolean;
    public skipMoreDelay: number;

    public simpleAlarms: boolean;
    public selectLastCommand: boolean;
    ...
    public getValue(setting: string) {
        switch (setting) {
            ...
            case 'display.defaultMXPState': return this.display.defaultMXPState;
            case 'simpleAlarms': return this.simpleAlarms;
            case 'selectLastCommand': return this.selectLastCommand;
            case 'mail.timeout': return this['mail.timeout'];
        }
        if (setting in this)
            return this[setting];
    ...
    public setValue(setting: string, value) {
        switch (setting) {
            ...
            case 'display.defaultMXPState':
                this.display.defaultMXPState = value;
                return true;
            case 'mail.timeout':
